  ...
  const steps = [
    ...
    },
    {
      ...
      description: [
        ...
        "Prepare Special Resolution Draft"
      ]
    },
    {
      number: "4.",
  ...
  const faqItems = [
    {
      ...
      answer:
        "Authorized share capital is the maximum amount of share capital that a company is legally allowed to issue to its shareholders as stated in its Memorandum of Association (MOA)."
    },
    {
      id: 2,
      question: "Why do companies increase their authorized share capital?",
      answer:
        "Companies increase their authorized share capital to issue more shares for raising funds, bringing in new investors, issuing bonus shares, or expanding operations."
    },
    {
      id: 3,
      question: "Is shareholder approval required to increase authorized share capital?",
      answer:
        "Yes, the company must obtain approval from its shareholders by passing a special resolution in a general meeting."
    },
    {
      id: 4,
      question: "What forms are required to be filed with the Registrar of Companies (ROC)?",
      answer:
        "Form MGT-14 (for the special resolution),Form SH-7 (for notice of increase in authorized capital)"
    },
    {
      id: 5,
      question: "Do I need to amend the Memorandum of Association (MOA)?",
      answer:
        "Yes, the capital clause of the MOA must be amended to reflect the new authorized share capital after approval."
    }
  ]
  ...
  return (
    <>
          ...
          <section>
            ...
            <div className="p-3 sm:p-6">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-4 ml-7">
                <li> Companies often need to issue more shares to raise capital for expansion, new projects, or working capital needs.</li>

                <li>Without sufficient authorised share capital, the company cannot legally issue new shares.</li>

                <li>As the business grows, additional funds may be required for acquisitions, scaling operations, or entering new markets.</li>

                <li>A higher authorised share capital ensures the company is ready for future funding rounds without delay.</li>

                <li>If the company plans to add new shareholders, investors, or partners, it must have enough authorised share capital to allot additional shares.</li>

                <li> Companies planning to reward existing shareholders with bonus shares must have adequate authorised capital to facilitate the allotment.</li>
              </p>
            </div>
          </section>
        </div>
      ...
      <section className="mb-10 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        FAQ on Increasing Authorized Share Capital
        </h1>
      ...
      <section className="px-4 md:px-6 max-w-7xl mx-auto mt-12 mb-6">
        ...
        <h1 className="text-3xl font-extrabold text-blue-900 leading-tight uppercase">
          STEPS INVOLVED IN<br />Increasing Authorized Share Capital
        </h1>
