        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto items-start w-full">
          ...
          <div className="w-full bg-white/20 backdrop-blur-xs border border-blue-800 p-6 sm:p-8 flex-1 rounded-md">
            ...
            <p className="mb-2 text-white">
               Help you in Director KYC.
            </p>
            <p className="text-white">
              Service Start From: <span className="text-white">₹Rs. 999/-</span>
            </p>
          </div>
      ...
      <div className="bg-blue-50 p-4 sm:p-6 md:p-10">
        <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
          ...
          <section>
            ...
            Why Director KYC is Important?
            </h2>
            <div className="p-3 sm:p-6">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-4">
                <li>To keep the DIN status Active and valid in MCA records.</li>

                <li>To avoid late filing penalties and additional government fees.</li>

                <li>If KYC is not completed, the individual will not be recognized as a director in any company in India.</li>

                <li> Compliance filings related to the company will be restricted until the DIN is re-activated through KYC completion.</li>
              </p>
            </div>
          </section>
        </div>
