  ...
  const steps = [
    {
      ...
      days: "DAY 1",
      description: [
        "Coordination Between the LegalBoss Team and Company Promoters/Directors",
        "Preparation of Required Documentation and Drafting of Resolutions",
      ],
    },
    {
      number: "2.",
      ...
      description: [
        ...
        "Drafting and Compilation of ROC Forms for Annual Filing",
      ],
    },
    {
      number: "3.",
      ...
      description: [
        ...
        "Payment of Applicable ROC Filing Fees",
      ],
    },
    {
      number: "4.",
      days: "DAY 5 Onwards",
      description: [
        " Timeline for ROC Review and Approval",
        "Issuance of Approval Letter Along with Acknowledged ROC Forms and Challan",
      ],
    },
  ];
  const scrollToTop = () => {
  ...
  const faqItems = [
    {
      id: 1,
      question:
        "Is it possible to revise the annual filing forms after submitting them to the ROC?",
      answer:
        "No, once the forms are filed with the ROC, they generally cannot be revised. Any correction may require a separate clarification or additional filing, depending on the case.",
    },
    {
      id: 2,
      question: " Is it mandatory to submit audited financial statements?",
      answer:
        "Yes, audited financial statements are compulsory for most companies, unless specifically exempted under the Companies Act based on turnover and other criteria.",
    },
    {
      id: 3,
      question:
        "My company had no business activity during the year. Do I still need to file annual forms with the ROC?",
      answer:
        "Yes, even if there were no transactions, you are still required to complete annual ROC filings to remain compliant and maintain active company status.",
    },
  ];
    ...
    <>
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto items-start w-full">
          ...
          <div className="w-full bg-white/20 backdrop-blur-xs border border-blue-800 p-6 sm:p-8 flex-1 rounded-md">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#14387f] mb-2 uppercase">
              Companies Annual Filling
            </h2>
            <p className="font-bold text-white mb-4 tracking-wide uppercase">
              Annual ROC Compliances
            </p>
            <p className="mb-2 text-white">
              Team help you in filling of Annual ROC Compliances.
            </p>
            <p className="mb-2 text-white">Just Rs.3999/-</p>
          </div>
          ...
          <section>
            <div className="p-3 sm:p-6">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-4 mb-4">
                All registered entities under the Companies Act, 2013 or 1956,
                including Private Limited Companies, Limited Companies, One
                Person Companies (OPC), Section 8 Companies, and others, are
                required to file their annual return and financial statements
                with the Registrar of Companies (ROC) every year. It is
                mandatory to file audited financial statements and the annual
                return with the ROC within 30 days and 60 days, respectively,
                from the date of the Annual General Meeting (AGM).
              </p>
              <b>Types of Annual Compliance:</b>
              <br />
              <b>Annual Return :</b>
              <p>
                The annual return includes details such as director information,
                the number of meetings held throughout the year, director
                attendance at meetings, changes in the board of directors,
                shareholder information, share transfers, director remuneration,
                turnover details, and capital structure. This must be filed in
                Form MGT-7/MGT-7A within 60 days from the conclusion of the AGM.
              </p>
              <b>Annual Accounts :</b>
              <p>
                The audited annual accounts must be submitted in Form AOC-4 to
                the ROC within 30 days of the AGM's conclusion. The accounts
                include the financial statements, such as the profit and loss
                account, balance sheet, director’s report (including related
                party transactions), and other relevant details.
              </p>
              <b>Auditor Appointment :</b>
              <p>
                If the auditor’s term expires at the AGM, the company must
                either renew the auditor’s term or appoint a new auditor. This
                must be communicated to the ROC within 15 days of the AGM in
                Form ADT-1.
              </p>
              <b>Why Annual ROC Filling:</b>
              <ul className="list-disc pl-4 sm:pl-5 space-y-2 sm:space-y-4 text-sm sm:text-base mb-4 text-gray-600 ">
                <li>
                  Helps the company avoid late filing penalties and ensures
                  smooth regulatory compliance.
                </li>
                <li>
                  Reduces the risk of legal action against the company and its
                  directors.
                </li>
                <li>
                  Enhances credibility and trust, which can attract potential
                  investors.
                </li>
                <li>
                  Ensures the company's status remains marked as "ACTIVE" in
                  official records.
                </li>
                <li>
                  Prevents directors from being disqualified due to
                  non-compliance.
                </li>
                <li>
                  Protects the company from being struck off by the Registrar of
                  Companies.
                </li>
              </ul>
            </div>
      ...
      <div className="mb-10 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-4xl font-extrabold text-blue-900 leading-tight">
          DOCUMENTS REQUIRED FOR ROC ANNUAL FILLING
        </h1>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 ml-6">
            <div>
              <ol className="list-decimal pl-4 sm:pl-5 space-y-2 sm:space-y-4 text-sm sm:text-base text-gray-600">
                ...
                <li>Independent Audit report with Board of Directors report</li>
                <li>Company Pan card</li>
                <li>List of Shareholders</li>
                <li>Share transfer deed, If any</li>
                <li>capital increase Forms with challan, if any</li>
                <li>During the Year Forms Filed to ROC with challan</li>
                <li>
                  Number of Board meeting and General meeting held in the year
                  with Date and resolution
                </li>
                <li>Meeting Attendance registered</li>
      ...
      <section className="px-4 md:px-6 max-w-7xl mx-auto mt-12 mb-6">
        ...
        <h1 className="text-3xl font-extrabold text-blue-900 leading-tight">
          STEPS INVOLVED IN ROC ANNUAL FILLING
        </h1>
