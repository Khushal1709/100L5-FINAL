  ...
  const plans = [
    {
      ...
      price: "₹12,999.00",
      items: [
        "Filling renewal application For One (1) Class, One (1) Application",
      ],
      highlight: false,
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto items-start w-full">
          ...
          <div className="w-full bg-white/20 backdrop-blur-xs border border-blue-800 p-6 sm:p-8 flex-1 rounded-md">
            ...
            <p className="font-bold text-white mb-4 tracking-wide uppercase">
              Handling of Tradeamrk Renewal
            </p>
            <p className="text-white">
              Service Start from Rs.12999/-</p>
          </div>
          ...
          <section>
            ...
            <div className="p-3 sm:p-6">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-4">
                <li>Without renewal, your trademark rights expire — renewal keeps your brand protected under the law.</li>

                <li>Renewal ensures that no one else can legally use your trademark or register a similar one.</li>

                <li>Your brand builds reputation and goodwill over time — renewing your trademark protects this valuable asset.</li>

                <li>If you miss the renewal deadline, restoring a lapsed trademark is costly, time-consuming, and not always guaranteed.</li>

                <li>A renewed trademark signals that your brand is active, strong, and serious about protecting its identity.</li>

                <li>Timely renewal eliminates the risk of losing your trademark rights and someone else taking advantage of your brand.</li>
              </p>
            </div>
          </section>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            <div>
              <ol className="list-decimal pl-4 sm:pl-5 space-y-2 sm:space-y-4 text-sm sm:text-base text-gray-600">
                ...
                <li>Authorization letter allowing your agent or attorney to act on your behalf.</li>
                <li>
                Updated Name, Address, and Contact Details of the trademark owner.
                </li>
                <li>
                PAN Card, Aadhaar Card, Passport, or any government-issued ID (for individuals)
                </li>
