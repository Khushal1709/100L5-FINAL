...
const plans = [
  ...
  // Additional 3 plans as requested
  {
    ...
    buttonColor: "bg-[#002C6D] text-white",
    features: [
      "DSC (Digital Signature Certificate) - 10",
      "DIN (Director Identification Number) - 5",
      "Company Name Reservation Application - 2 Times",
      "Registration Fees on capital up to Rs. 2 Lakh",
      "Stamp duty on capital up to Rs. 2 Lakh",
      "E-MOA and E-AOA",
      "PAN and TAN",
      "PF Registration",
      "ESIC Registration",
      ...
      "MSME Registration",
      "GST Registration",
      "Trademark Application - 2 Brand/2 Class",
      "Complementary Incorporation Kit",
      "MOA and AOA - 2 Copies",
      "Draft 1st Meeting of Minutes",
  ...
  },
  {
    ...
    buttonColor: "bg-[#002C6D] text-white",
    features: [
      "DSC (Digital Signature Certificate) - 12",
      "DIN (Director Identification Number) - 7",
      "Company Name Reservation Application - 3 Times",
      "Registration Fees on capital up to Rs. 5 Lakh",
      "Stamp duty on capital up to Rs. 5 Lakh",
      "E-MOA and E-AOA",
      "PAN and TAN",
      "PF Registration",
      "ESIC Registration",
      ...
      "MSME Registration",
      "GST Registration",
      "Trademark Application - 3 Brand/3 Class",
      "Complementary Incorporation Kit",
      "MOA and AOA - 3 Copies",
      "Draft 1st Meeting of Minutes",
      "12 Month Social Media Marketing Tool",
      "Share Certificates",
      "Customized Printing T-Shirt with Logo - 5 Nos.",
      "Assistance in bank Account Opening",
      "Business Email Setup",
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        ...
        {/* Main Content */}
        <div className=" px-4 sm:px-6 py-8 -mt-16 relative z-20">
