...
const IECCODE = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      days: "DAY 3-4",
      description: [
        " Preparation of IEC Application",
        "Submission of IEC Application",
      ],
    },
  ];
  const scrollToTop = () => {
  ...
  const plans = [
    {
      ...
      items: [
        "Preparation of IEC application",
        "Getting  DSC certificate - 2 years validity",
        "Filling a IEC application with DGFT",
      ],
      highlight: false,
    },
    {
      ...
      price: "RS.1999.00",
      items: [
        "Preparation of IEC code application",
        "Filling of IEC Application with DGFT",
      ],
      highlight: true,
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "IEC (Import Export Code) is a 10-digit identification number issued by the DGFT (Director General of Foreign Trade) to individuals or businesses involved in import or export activities in India.",
    },
    {
      id: 2,
      question: "Is IEC mandatory for all imports and exports?",
      answer:
        "Yes, IEC is mandatory for any commercial import or export of goods and services. It is not required for personal use.",
    },
    {
      id: 3,
      question: "Who needs to apply for an IEC?",
      answer:
        "Any individual, business, partnership, company, or organization intending to import or export goods/services from India must apply for an IEC.",
    },
    {
      id: 4,
      question: "How do I apply for an IEC Code?",
      answer:
        "You can apply online through the official DGFT website by filling out the application form and uploading the required documents such as PAN card, proof of address, and bank details.",
    },
    {
      id: 5,
      question: "Can I update my IEC details later?",
      answer:
        "Yes, you can modify your IEC details (like address, contact info, etc.) through the DGFT portal.",
    },
    {
      id: 6,
      question: "Is IEC required for service exports too?",
      answer:
        "In some cases, yes. If the service export requires a benefit from DGFT or a bank requires IEC for remittance, it may be needed.",
    },
    {
      id: 7,
      question: " Can a person apply for an IEC Code?",
      answer: "Yes, an individual can apply for an IEC Code.",
    },
  ];
      ...
      `}
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto items-start w-full">
          ...
          <div className="w-full bg-white/20 backdrop-blur-xs border border-blue-800 p-6 sm:p-8 flex-1 rounded-md">
            ...
            <p className="mb-2 text-white">Team help you in getting IEC Code</p>
          ...
          <section>
            ...
            <div className="p-3 sm:p-6">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-4">
                Any legal entity in India planning to engage in international
                trade—whether importing or exporting goods—must obtain an Import
                Export Code (IEC).Issued by the Director General of Foreign
                Trade (DGFT), the IEC is a unique 10-digit identifier that is
                compulsory for all businesses involved in import or export
                activities.This code is required only when goods are traded for
                commercial purposes. It is not necessary for personal imports or
                exports.Without an IEC, importers cannot bring goods into the
                country legally, and exporters will be ineligible for various
                benefits and incentives provided by DGFT, customs departments,
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 ml-6">
            <div>
              <ol className="list-decimal pl-4 sm:pl-5 space-y-2 sm:space-y-4 text-sm sm:text-base text-gray-600">
                <li>Pan Card-Individual </li>
                <li>Address Proof-Individual</li>
                <li>Photograph of Individual,Partners,Directors</li>
                <li>Bank Certificate/Pre-printed Cancelled Cheque</li>
                <li>Emial ID & Contact Number</li>
                <li>
                  If the address proof is not in the name of the applicant
                  entity, a No Objection Certificate (NOC) from the property
                  owner, along with their address proof, should be provided.
                </li>
              </ol>
            </div>
