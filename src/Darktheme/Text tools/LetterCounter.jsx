      ...
      <div className="max-w-4xl mx-auto mt-8">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
          <div className="flex items-center gap-3 mb-2 sm:mb-0">
            ...
            <h1 className="text-2xl font-bold text-white md:text-lg lg:text-2xl sm:text-lg">Letter&nbsp;Counter</h1>
          </div>
        ...
        <textarea
          className="w-full h-40 p-4 border border-gray-500 rounded-2xl outline-none text-base bg-[#16283E] mb-4"
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          <div className="flex-1 bg-[#16283E] rounded-lg border border-gray-500 py-4 flex flex-col items-center">
            <span className="text-2xl font-bold text-gray-400">{sentenceCount}</span>
            <span className="text-xs text-gray-400 mt-1">sentence</span>
          </div>
          <div className="flex-1 bg-[#16283E] rounded-lg border border-gray-500 py-4 flex flex-col items-center">
            <span className="text-2xl font-bold text-gray-400">{wordCount}</span>
            <span className="text-xs text-gray-400 mt-1">word</span>
          </div>
          <div className="flex-1 bg-[#16283E] rounded-lg border border-gray-500 py-4 flex flex-col items-center">
            <span className="text-2xl font-bold text-gray-400">{letterCount}</span>
            <span className="text-xs text-gray-400 mt-1">letter</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="w-full overflow-x-auto">
            <table className="hidden md:table w-full text-sm border border-gray-500 rounded-lg bg-[#16283E]">
              <thead>
                <tr className="bg-[#16283E]">
