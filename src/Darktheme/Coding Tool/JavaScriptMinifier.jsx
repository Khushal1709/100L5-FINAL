    ...
    <div className="max-w-4xl mx-auto mt-7">
      {/* Header */}
       <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
        <div className="flex items-center gap-3 mb-2 sm:mb-0">
          ...
          <span className="text-2xl text-white md:text-lg lg:text-2xl sm:text-lg">
     ...
     {/* Share Popup */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-4xl mx-auto">
        ...
        <button
          className="px-8 py-2 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer transition"
          onClick={handleMinify}
        >
          Minify &rarr;
        </button>
        <button
          className="px-6 py-2 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer flex items-center gap-2 text-[#a99cff] transition"
        ...
        <button
          className={`px-6 py-2 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer flex items-center gap-2 transition ${
            isCopied
              ? "text-white bg-[#273D58] border-white"
              : "text-white bg-[#273D58] border-white"
          }`}
          onClick={handleCopy}
          disabled={!output}
