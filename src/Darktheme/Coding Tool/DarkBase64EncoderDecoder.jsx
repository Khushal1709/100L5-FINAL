...
export default function DarkBase64EncoderDecoder({ id = "Base64 Encoder Decoder Generator" }) {
    ...
    <>
      <div className="max-w-4xl mx-auto mt-8">
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row gap-4 mb-4">
          {/* Input Area */}
          <div className="flex-1  bg-[#16283E] rounded-xl border border-gray-500 p-4 min-h-[220px] flex flex-col">
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button
            className={`px-6 py-2 bg-[#273D58]  border border-gray-200 rounded-lg flex items-center gap-2 transition cursor-pointer ${isCopied
                ? "bg-[#273D58]  border border-white text-white"
                : "bg-[#273D58]  border border-white text-white"
              }`}
            onClick={handleCopy}
