  ...
  return (
    ...
    {/* Share Popup */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-4xl mx-auto mt-2">
        <button
          className="px-8 py-3  bg-[#273D58]  border border-white text-white rounded-lg flex items-center gap-2 cursor-pointer"
          onClick={handleReset}
        >
          Reset
        </button>
        <button
          className={`px-8 py-3  bg-[#273D58]  border border-white text-white rounded-lg ${!input.trim() ? " cursor-not-allowed" : ""}`}
