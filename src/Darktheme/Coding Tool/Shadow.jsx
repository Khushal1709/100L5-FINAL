      ...
      <div className="max-w-4xl mx-auto p-2">
        ...
        <div className="w-full max-w-4xl flex gap-6 items-center mb-8">
          ...
          <div className="flex flex-col">
            <label className="text-xs text-white mb-1 mt-2">Shadow Color</label>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={shadowColor}
                onChange={(e) => setShadowColor(e.target.value)}
                className="px-2 py-1 rounded-lg border border-gray-200 text-sm bg-[#273D58] text-white w-28 outline-none"
              />
            </div>
          </div>
          {/* Shadow Depth */}
          <div className="flex-1 flex flex-col">
            <label className="text-xs text-white mb-1">Shadow Depth: {shadowDepth}</label>
            <input
              type="range"
              min={1}
              max={24}
        ...
        <div className="w-full max-w-5xl flex flex-wrap md:flex-nowrap gap-8 items-start mb-8">
          ...
          <div className="flex-1 flex flex-col items-center">
            <span className="mb-2 flex items-center gap-1 text-white text-sm">
          ...
          {/* Code Box */}
          <div className="flex-1 bg-[#16283E] border border-gray-500 rounded-xl p-4 min-w-[260px] max-w-xs">
            <div className="text-xs text-gray-500 mb-2 font-semibold">React Native Shadow Style</div>
            <pre className=" bg-[#16283E] rounded-lg p-3 text-xs text-white overflow-x-auto">
...
elevation: ${shadowStyle.elevation},`}
            ...
            <button className="mt-4 w-full py-2 bg-[#273D58] border border-white rounded-lg font-semibold transition">
              Copy Code
            </button>
          </div>
        </div>
