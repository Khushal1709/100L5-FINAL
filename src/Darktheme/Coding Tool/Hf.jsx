  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
      ...
      <div className="flex flex-col md:flex-row gap-4 max-w-4xl mx-auto mb-4">
        {/* Input Area */}
        <div className="flex-1  bg-[#16283E] rounded-xl border border-gray-200 p-4 min-h-[260px] flex flex-col">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-4xl mx-auto mt-2">
        <button
          className="px-8 py-3 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer transition flex items-center gap-2 text-base"
          onClick={handleReset}
        >
          Reset
        </button>
        <button
          className={`px-12 py-3 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer text-base ${!input.trim() ? "cursor-not-allowed" : ""}`}
        ...
        <button
          className="px-8 py-3 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer flex items-center gap-2 text-[#a99cff]  transition"
        ...
        <button
          className={`px-8 py-3 bg-[#273D58] text-white border border-white rounded-lg cursor-pointer flex items-center gap-2 transition ${
            isCopied
              ? "text-white bg-[#273D58] border border-[#a99cff]"
