    ...
    <>
      <div className="max-w-4xl mx-auto mt-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-4xl mx-auto">
          ...
          <button
            className="px-8 py-2 bg-[#273D58]  border border-white text-white rounded-lg rounded-lg font-semibold shadow cursor-pointer transition"
            onClick={handleAction}
          >
            {tab === "encode" ? "Encode \u2192" : "Decode \u2192"}
          </button>
          <button
            className={`px-6 py-2 bg-[#273D58]  border border-white text-white rounded-lg cursor-pointer rounded-lg flex items-center gap-2 transition ${isCopied
                ? "bg-[#273D58]  border border-white text-white rounded-lg"
                : "text-[#5b63e6]"
              }`}
            onClick={handleCopy}
