...
const CodeToImageConverter = ({id="Code to Image Generator"}) => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto  p-2 sm:p-4">
        {/* Header */}
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 bg-[#16283E] rounded-lg p-3 sm:p-4  gap-2">
           <div className="flex items-center gap-3 mb-2 sm:mb-0">
          <span className="text-4xl text-blue-400 mt-3">
            <RiCodeBlock />
          </span>
          <h1 className="text-2xl font-bold text-white md:text-lg lg:text-2xl sm:text-lg mt-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6 p-3">
          <div>
            ...
            <select
              ...
              className="w-full p-2 border bg-[#16283E] border-gray-500 rounded-md outline-none text-white"
            >
              {languages.map((lang) => (
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2 border border-gray-500 rounded-md outline-none text-white bg-[#16283E] "
            >
              {themes.map((theme) => (
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-500 rounded-md outline-none text-white"
            />
          </div>
          <div className="flex items-end">
            <button
              onClick={() => setShowSettings(!showSettings)}
              className="flex items-center space-x-2 px-4 py-2 bg-[#16283E] border border-gray-500 rounded-md transition-colors w-full justify-center text-white"
            >
              <Settings size={16} />
              <span>Settings</span>
            </button>
        ...
        {showSettings && (
          <div className="bg-[#16283E] rounded-lg shadow-sm p-3 sm:p-6 mb-4 sm:mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-500 rounded-md outline-none bg-[#16283E] text-white"
                >
        ...
        <div className="bg-[#16283E] rounded-lg shadow-sm mb-4 sm:mb-6">
          <div className="p-3 sm:p-6">
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <textarea
                ...
                className="w-full h-48 sm:h-64 p-3 sm:p-4 border border-gray-500 rounded-md font-mono text-sm resize-y outline-none text-white"
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              {previewModes.map((mode) => (
                <button
                  ...
                  className={`px-4 py-1.5 rounded font-medium text-sm transition-colors bg-[#16283E] border border-white cursor-pointer
                    ${
                      previewMode === mode
                        ? "bg-[#16283E] text-white shadow"
                        : "bg-[#16283E] text-white "
                    }
                    focus:outline-none`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-500 bg-[#16283E] text-white rounded-md outline-none"
                >
                  {positions.map((pos) => (
              ...
              <div>
                ...
                <button
                  ...
                  className="w-full p-2 border border-gray-500 bg-[#16283E] text-white  rounded-md cursor-pointer flex items-center justify-center space-x-2"
                >
                  <Upload size={16} />
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-8 h-8 border border-gray-500 rounded cursor-pointer bg-[#16283E] text-white"
                  />
                  <input
                    type="text"
                    value={fontColor}
                    onChange={(e) => setFontColor(e.target.value)}
                    className="flex-1 p-2 border border-gray-500 rounded-md text-sm outline-none bg-[#16283E] text-white"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6">
          <div className="lg:col-span-2">
            <div className="bg-[#16283E] rounded-lg shadow-sm p-3 sm:p-6">
          ...
          <div>
            <button
              ...
              disabled={isExporting}
              className="w-full bg-[#16283E] border border-white cursor-pointer disabled:bg-blue-400 text-white py-3 px-6 rounded-lg font-medium flex items-center justify-center space-x-2 transition-colors"
            >
              <Download size={18} />
