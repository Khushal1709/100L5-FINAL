  ...
  const tools = [
    {
      ...
      icon: (
        <RiCodeBlock className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/CodetoImage",
    },
    {
      ...
      icon: (
        <FaLink className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-yellow-400" />
      ),
      filename: "/Slug",
    },
    {
      ...
      icon: (
        <FaReact className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-pink-400" />
      ),
      filename: "/Shadow",
    },
    {
      ...
      icon: (
        <PiDatabaseBold className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-orange-400" />
      ),
      filename: "/BaseEncoderDecoder",
    },
    {
      ...
      icon: (
        <TbHtml className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-pink-400" />
      ),
      filename: "/HTMLEncoderDecoder",
    },
    {
      ...
      icon: (
        <PiFileHtmlBold className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-orange-400" />
      ),
      filename: "/URLEncoderDecoder",
    },
    {
      ...
      icon: (
        <ImHtmlFive2 className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/HTMLMinifier",
    },
    {
      ...
      icon: (
        <PiFileCssLight className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-yellow-400" />
      ),
      filename: "/CSSMinifier",
    },
    {
      ...
      icon: (
        <PiFileJsxBold className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/JavaScriptMinifier",
    },
    {
      ...
      icon: (
        <LiaHtml5 className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-yellow-400" />
      ),
    ...
    },
    {
      ...
      icon: (
        <SiCsswizardry className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-pink-400" />
      ),
    ...
    },
    {
      ...
      icon: (
        <PiFileJsxBold className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-orange-400" />
      ),
  ...
  const ToolCard = ({ tool, index }) => {
    ...
    return (
      ...
      >
        ...
        {/* Title */}
        <h3 className="text-left text-[17px] whitespace-nowrap font-semibold text-white mb-2 break-words">
          {tool.title}
        </h3>
