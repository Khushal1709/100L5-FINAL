                ...
                <div className="max-w-4xl mx-auto p-2">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
                        <div className="flex items-center gap-3 mb-2 mt-5 sm:mb-0">
                            <span className="text-4xl text-yellow-400 mt-6">
                                <FaCropSimple />
                            </span>
                        ...
                        <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4  mt-8 lg:justify-end lg:gap-2">
                            <button
                                onClick={() => setShareOpen(true)}
                                className="flex items-center justify-center md:w-auto px-3 py-2 text-sm rounded-xl 00 mb-2 md:mb-0 cursor-pointer text-white bg-[#273D58] border"
                            >
                                <FiShare2 className="mr-2" size={18} />
                                Share
                            </button>
                            <button
                                className="flex items-center justify-center gap-2 w-full md:w-auto px-3 py-2 text-sm rounded-xl border  bg-[#273D58]  text-white cursor-pointer hover:bg-indigo-100 transition"
                            ...
                            <button
                                ...
                                className={`px-3 py-2 rounded-xl  text-sm mt-2 md:mt-0 ml-0 cursor-pointer bg-[#273D58] border  text-white border-white ${isFavorite
                                    ? ""
                                    : ""
                                    }`}
                            >
                    ...
                    <div className="flex flex-col sm:flex-row w-full max-w-4xl gap-3 sm:gap-4 justify-between mb-4 px-2 sm:px-4">
                        <button
                            className="w-full sm:w-auto px-6 py-2 rounded-lg cursor-pointer border bg-[#273D58] text-white disabled:opacity-50"
                        ...
                        <button
                            className="w-full sm:w-auto px-6 py-2 border rounded-lg cursor-pointer bg-[#273D58] text-white"
                            onClick={handleReset}
                        >
                            Reset
                        </button>
                        <button
                            className="w-full sm:w-auto px-6 py-2 rounded-lg cursor-pointer  disabled:opacity-50  bg-[#273D58] text-white border"
