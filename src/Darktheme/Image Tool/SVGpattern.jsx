        ...
        <div className="max-w-4xl mx-auto p-3">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
                ...
                <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 md:mt-5 lg:justify-end lg:gap-2">
                    ...
                    <button
                        className="flex items-center justify-center gap-2 w-full md:w-auto px-3 py-2 text-sm rounded-xl border bg-[#273D58] text-white  transition"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                ...
                <div className="space-y-6 ">
                    ...
                    <div className="relative">
                        <label className="block text-sm font-medium  text-white mb-1 ">Pattern Type</label>
                        <div className="relative ">
                            <button
                                onClick={() => setShowDropdown(!showDropdown)}
                                className="relative w-full bg-[#273D58]  text-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default  sm:text-sm"
                            >
                            ...
                            {showDropdown && (
                                <div className="absolute  text-white bg-[#273D58] mt-1 w-full z-50 shadow-lg max-h-60 rounded-md py-1 text-base  overflow-auto  sm:text-sm">
                                    <div
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-white mb-1">Pattern Color</label>
                            <div className="flex items-center">
                                <input
                                    type="color"
                                    value={patternColor}
                                    onChange={(e) => setPatternColor(e.target.value)}
                                    className="w-10 h-10 p-0 border-0 rounded text-white"
                                />
                                <input
                                    type="text"
                                    value={patternColor}
                                    onChange={(e) => setPatternColor(e.target.value)}
                                    className="text-white ml-2 flex-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm  sm:text-sm"
                                />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="flex items-center">
                                ...
                                <input
                                    ...
                                    value={backgroundColor}
                                    onChange={(e) => setBackgroundColor(e.target.value)}
                                    className="ml-2 flex-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-white sm:text-sm"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-lg font-medium text-white">Pattern Settings</h3>
                            <button
                                onClick={handleReset}
                                className="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-white  bg-[#273D58]"
                            >
                                Reset
                            </button>
                        </div>
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                <label className="block text-sm font-medium text-white">Size: {size}px</label>
                            </div>
                            <input
                                type="range"
                                min="8"
                                ...
                                className="w-full h-2 accent-white rounded-lg  cursor-pointer mt-2"
                            />
                        </div>
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                <label className="block text-sm font-medium text-white">Spacing: {spacing}px</label>
                            </div>
                            <input
                                type="range"
                                min="0"
                                ...
                                className="w-full h-2 bg-gray-200 rounded-lg accent-white cursor-pointer mt-2"
                            />
                        </div>
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                <label className="block text-sm font-medium text-white">Rotation: {rotation}deg</label>
                            </div>
                            <input
                                type="range"
                                min="0"
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                <label className="block text-sm font-medium text-white">Skew: {skew}deg</label>
                            </div>
                            <input
                                type="range"
                                min="-90"
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                <label className="block text-sm font-medium text-white">Pattern Opacity: {opacity}</label>
                            </div>
                            <input
                                type="range"
                                min="0"
                    ...
                    <div>
                        <h3 className="text-lg font-medium text-white mb-2">Export Size Settings</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="block w-full px-3 py-2 border text-white border-gray-300 rounded-md shadow-sm  sm:text-sm"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="block w-full px-3 py-2 border border-gray-300 text-white rounded-md shadow-sm sm:text-sm"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className="inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm  rounded-md bg-[#273D58] text-white "
                        >
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className=" cursor-pointer border text-white bg-[#273D58] inline-flex justify-center items-center px-4 py-2  text-sm  rounded-md shadow-sm "
                        >
                            Export
                        </button>
                    </div>
