  ...
  return (
    <>
      <div className="bg-[#16283E]">
        <div className="max-w-4xl mx-auto p-3 bg-[#16283E]">
          {/* Header */}
          <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2 ">
            <div className="flex items-center gap-3 mb-2 sm:mb-0">
              <span className="text-4xl text-indigo-400 mt-7">
                <MdMovieFilter />
              </span>
              <span className="text-2xl font-bold text-white md:text-lg lg:text-2xl sm:text-lg mt-7">
                Photo&nbsp;Censor
              </span>
            </div>
            <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 mt-4 lg:justify-end lg:gap-2 ">
              <button
                ...
                className="bg-[#273D58] flex items-center justify-center md:w-auto px-3 py-2 text-sm rounded-xl border text-white mb-2 md:mb-0 cursor-pointer"
              >
              ...
              <button
                ...
                className={`px-3 py-2 rounded-xl border text-sm mt-2 md:mt-0 ml-0 cursor-pointer bg-[#273D58] ${isFavorite
                  ? "text-white"
                  : " text-white"
                  }`}
              >
          ...
          {!imageSrc && (
            <div className="border-2 border-dashed border-gray-300 rounded-lg h-40 flex flex-col items-center justify-center mb-6">
              <label className="cursor-pointer flex flex-col items-center ">
                <svg width="36" height="36" fill="none" stroke="currentColor" strokeWidth="2" className="mb-2 text-gray-500">
                  <path d="M12 16v6h8v-6h5l-9-9-9 9h5z"></path>
                  <path d="M20 21v2a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-2"></path>
                </svg>
                <span className="text-gray-500">Drag your image here, or click to <span className="font-semibold underline">browse</span></span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 mb-4">
            <div className="flex items-center gap-2">
              <label className="text-sm font-medium text-white">Censor Type</label>
              <select
                className="border border-gray-200   bg-[#16283E] rounded px-2 py-1 text-white "
                value={censorType}
            ...
            <div className="flex items-center gap-2">
              <label className="text-sm font-medium text-white">Pixel Size: {pixelSize}px</label>
              <input
                type="range"
                min={5}
                max={30}
          ...
          <div className="flex gap-2">
            <button
              className={`cursor-pointer bg-[#273D58] text-white border border-white flex-1 py-2 rounded-lg `}
