...
export default function Sidebar() {
  ...
  const sections = [
    ...
    },
    {
      ...
      label: "Text Tools",
      items: [
        { label: "Case Converter", icon: <VscCaseSensitive className="text-blue-400"/>, link: "/caseconverter" },
        { label: "Lorem Ipsum Generator", icon: <MdOutlineContentPaste  className="text-yellow-400"/>, link: "/lorem" },
        { label: "Letter Counter", icon: <SlEnvolopeLetter className="text-pink-400"/>, link: "/letter" },
        { label: "Text to Handwriting", icon: <TbTransform className="text-orange-400"/>, link: "/Text" },
        { label: "Bionic Reading Converter", icon: <FaBookReader className="text-pink-400"/>, link: "/BionicReading" },
        { label: "Multiple Whitespace Remove", icon: <BsScissors className="text-orange-400"/>, link: "/Whitespace" },
        { label: "Google Fonts Pair Finder", icon: <MdGroups className="text-blue-400"/>, link: "/Googlefont" },
      ],
    },
    {
      key: "image",
      ...
      label: "Image Tools",
      items: [
        { label: "Image Resizer", icon: <BsTextareaResize className="text-blue-400"/>, link: "/Resizer" },
        { label: "Image Cropper", icon: <FaCropSimple className="text-yellow-400"/>, link: "/ImageCropper" },
        { label: "Image Average Color Finder", icon: <MdFormatColorFill className="text-pink-400"/>, link: "/AverageColor" },
        { label: "Image Color Extractor", icon: <FaCropSimple className="text-orange-400"/>, link: "/ImageColorExtractor" },
        { label: "Image Color Picker", icon: <TbColorPicker className="text-pink-400"/>, link: "/ImageColorPicker" },
        { label: "SVGpattern", icon: <TbFileTypeSvg className="text-orange-400"/>, link: "/SVGpattern" },
        { label: "Photo Censor", icon: <MdMovieFilter className="text-blue-400"/>, link: "/Photocensor" },
        { label: "SVG to PNG Converter", icon: <SiConvertio className="text-yellow-400"/>, link: "/Svgpng" },
        { label: "Image Filter", icon: <TbFilters className="text-blue-400"/>, link: "/Imagefilter" },
        { label: "Image Caption", icon: <MdOutlineImageSearch className="text-yellow-400"/>, link: "/ImageCaptionGenerator" }, // Fixed icon
        { label: "BlobGenerator", icon: <GiSlowBlob className="text-pink-400"/>, link: "/BlobGenerator" },
      ],
    },
    {
      key: "css",
      ...
      label: "CSS Tools",
      items: [
        { label: "CSS Clip Path Generator", icon: <MdOutlineDocumentScanner className="text-blue-400"/>, link: "/Cssclippathgenerator" },
        { label: "CSS Loader", icon: <LuLoader className="text-yellow-400"/>, link: "/Cssloader" },
        { label: "CSS Background Pattern", icon: <TbBackground className="text-pink-400"/>, link: "/CSSbackgroundpattern" },
        { label: "CSS Cubic Bezier Generator", icon: <LuSpline className="text-orange-400"/>, link: "/Csscubic" },
        { label: "CSS Glass Morphism", icon: <IoMdPhonePortrait className="text-pink-400"/>, link: "/Cssglassmorphism" },
        { label: "CSS Text Glitch", icon: <CgGoogle className="text-orange-400"/>, link: "/Csstextglitch" },
        { label: "CSS Gradient Generator", icon: <MdGradient className="text-blue-400"/>, link: "/Cssgradientgenerator" },
        { label: "CSS Triangle Generator", icon: <IoTriangleSharp className="text-yellow-400"/>, link: "/CSStrianglegenerator" },
        { label: "CSS Box Shadow Generator", icon: <FaBoxArchive className="text-orange-400"/>, link: "/Cssboxshadowgenerator" },
        { label: "Border Radius Generator", icon: <AiOutlineRadiusUpright className="text-pink-400"/>, link: "/Borderradiusgenerator" },
      ],
    },
    {
      key: "coding",
      ...
      label: "Coding Tools",
      items: [
        { label: "Code to Image Generator", icon: <RiCodeBlock className="text-blue-400"/>, link: "/CodetoImage" },
        { label: "URL Slug Generator", icon: <FaLink className="text-yellow-400"/>, link: "/Slug" },
        { label: "React Native Shadow Generator", icon: <FaReact className="text-pink-400"/>, link: "/Shadow" },
        { label: "Base64 Encoder Decoder Generator", icon: <FaBrain className="text-blue-400"/>, link: "/BaseEncoderDecoder" },
        { label: "HTML Encoder/Decoder", icon: <TbHtml className="text-pink-400"/>, link: "/HTMLEncoderDecoder" },
        { label: "URL Encoder/Decoder", icon: <PiFileHtmlBold className="text-orange-400"/>, link: "/URLEncoderDcoder" },
        { label: "HTML Minifier", icon: <ImHtmlFive2 className="text-blue-400"/>, link: "/HTMLMinifier" },
        { label: "CSS Minifier", icon: <PiFileCssLight className="text-yellow-400"/>, link: "/CSSMinifier" },
        { label: "JavaScript Minifier", icon: <PiFileJsxBold className="text-blue-400"/>, link: "/JavaScriptMinifier" },
        { label: "HTML Formatter", icon: <LiaHtml5 className="text-yellow-400"/>, link: "/Hf" },
        { label: "CSS Formatter", icon: <SiCsswizardry className="text-pink-400"/>, link: "/Cs" },
        { label: "JavaScript Formatter", icon: <PiFileJsxBold className="text-orange-400" />, link: "/Javaf" },
      ],
    },
    {
      key: "color",
      ...
      label: "Color Tools",
      items: [
        { label: "AI Color Palette Generator", icon: <FaBrain className="text-blue-400"/>, link: "/AIColor" },
        { label: "HEX to RGBA Converter", icon: <IoColorFilterOutline className="text-yellow-400"/>, link: "/HEX" },
        { label: "RGBA to HEX Converter", icon: <FaHashtag className="text-pink-400"/>, link: "/RGBA" },
        { label: "Color Mixer", icon: <HiCircleStack className="text-orange-400"/>, link: "/ColorMixer" },
        { label: "Color Shades Generator", icon: <FaSwatchbook className="text-blue-400"/>, link: "/ColorShades" },
      ],
    },
    {
      key: "social",
      ...
      items: [
        { label: "Instagram Filters", icon: <MdMovieFilter className="text-blue-400"/>, link: "/InstagramFilters" },
        { label: "Instagram Post Generator", icon: <MdPostAdd className="text-yellow-400"/>, link: "/InstagramPostGenerator" },
        { label: "Tweet Generator", icon: <FaTwitterSquare className="text-pink-400"/>, link: "/TweetGenerator" },
        { label: "Open Graph Meta Generator", icon: <LuGitGraph className="text-orange-400"/>, link: "/Opengraphmetagenerator" },
        { label: "Vimeo Thumbnail Grabber", icon: <IoLogoVimeo className="text-pink-400"/>, link: "/Vimeothumbnailgrabber" },
        { label: "YouTube Thumbnail Grabber", icon: <FaYoutube className="text-orange-400"/>, link: "/Youtubethumbnailgrabber" },
        { label: "Twitter Ad Revenue Generator", icon: <FaXTwitter className="text-blue-400"/>, link: "/Twitteradrevenuegenerator" },
      ],
    },
    {
      key: "misc",
      ...
      items: [
        { label: "Strong Random Password Generator", icon: <BiSolidLock className="text-blue-400"/>, link: "/StrongRandom" },
        { label: "List Randomizer", icon: <MdOutlineContentPaste className="text-yellow-400"/>, link: "/Randomizer" },
        { label: "QR Code Generator", icon: <BsQrCode className="text-pink-400"/>, link: "/QRcode" },
        { label: "Bar Code Generator", icon: <ImBarcode className="text-orange-400"/>, link: "/Barcode" },
      ],
    },
  ]
