            ...
            <div className=' bg-[#16283E] '>
                <div className="max-w-4xl mx-auto p-3 md:py-7">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
                        ...
                        <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 lg:justify-end lg:gap-2">
                            <button
                                ...
                                className="flex items-center justify-center  bg-[#273D58]  text-white md:w-auto px-3 py-2 text-sm rounded-xl border  border-white mb-2 md:mb-0 cursor-pointer"
                            >
                                <FiShare2 className="mr-2" size={18} />
                                Share
                            </button>
                            <button
                                className="flex items-center justify-center  bg-[#273D58]  text-white gap-2 w-full md:w-auto px-3 py-2 text-sm rounded-xl border border-white  transition"
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                <div className={`instagram-post ${theme === 'Dark' ? 'bg-gray-900 text-white' : 'bg-white'}`}>
                                    ...
                                    <div className="flex p-2 xl:w-[440px]">
                                        <div className="flex space-x-4">
                                            ...
                                            <button className={`w-7 h-7 rotate-315 ${theme === 'Dark' ? 'text-white' : 'text-black'}`}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        ...
                        <div className="flex-1">
                            <div>
                                <h2 className="text-lg font-semibold mb-4 text-white">Post Body</h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full border text-white rounded-md px-3 py-2 outline-none  bg-[#16283E] "
                                        >
                                    ...
                                    <div className="flex items-end gap-2">
                                        <div className="flex-grow">
                                            ...
                                            <input
                                                ...
                                                className="w-full border border-gray-300  text-white rounded-md px-3 py-2 outline-none"
                                            />
                                        </div>
                                        <button
                                            className={`px-3 py-2 border rounded-md text-sm font-medium ${verified ? ' text-white' : ' text-gray-600 border-gray-200'}`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-gray-300 rounded-md px-3 py-2 outline-none text-white"
                                            placeholder="New York, USA"
                                        />
                                    </div>
                                    {/* Post Date */}
                                    <div>
                                        <label className="block text-sm font-medium text-white mb-1">Post Date</label>
                                        <input
                                            type="datetime-local"
                                            value={postDate}
                                    ...
                                    {/* Avatar Upload */}
                                    <div>
                                        <label className="block text-sm font-medium text-white mb-1">Avatar</label>
                                        <div
                                            className="w-full border border-gray-300 rounded-md px-3 py-2 flex items-center cursor-pointer text-white outline-none"
                                    ...
                                    {/* Post Image Upload */}
                                    <div>
                                        <label className="block text-sm font-medium text-white mb-1">Post Image</label>
                                        <div
                                            className="w-full border border-gray-300 rounded-md px-3 py-2 flex items-center cursor-pointer "
                                ...
                                {/* Stats */}
                                <h2 className="text-lg font-semibold mb-4 text-white">Stats & States</h2>
                                {/* Counts */}
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">

                                    <div>
                                        <label className="block text-sm font-medium text-white mb-1">Like Count</label>
                                        <input
                                            type="text"
                                            value={likeCount}
                                            onChange={(e) => setLikeCount(e.target.value)}
                                            className="w-full border  rounded-md px-3 py-2 text-white outline-none"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-white mb-1">Comment Count</label>
                                        <input
                                            type="text"
                                            value={commentCount}
                                            onChange={(e) => setCommentCount(e.target.value)}
                                            className="w-full border   rounded-md  text-white px-3 py-2 outline-none"
                                        />
                                    </div>
                                </div>
                                {/* Checkboxes */}
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="isLiked" className="ml-2 block text-sm text-white">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="isTagged" className="ml-2 block text-sm text-white">
                                            Is someone tagged?
                                        </label>
                                    </div>
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                                        />
                                        <label htmlFor="hasStory" className="ml-2 block text-sm text-white">
                                    ...
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                                        />
                                        <label htmlFor="showComments" className="ml-2 block text-sm text-white">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <div className="relative inline-block" ref={dropdownRef}>
                            <button
                                ...
                                className="cursor-pointer text-white bg-[#273D58] border   px-8 py-2 rounded-full  text-lg flex items-center justify-center mx-auto transition-colors"
                            >
                            ...
                            {showDropdown && (
                                <div className="absolute z-10 mt-2 w-56 origin-top-right right-0 rounded">
                                    <div className="py-1">
                                        <button
                                            onClick={downloadImage}
                                            className="block w-full text-left px-4 py-2 text-sm text-white bg-[#273D58]"
                                        >
                                            <div className="flex items-center">
