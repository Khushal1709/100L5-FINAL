          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mt-2 gap-2">
              <div className="flex items-center gap-3 mb-2 sm:mb-0">
                ...
                <span className="text-lg font-bold text-white md:text-lg mt-2 lg:text-2xl sm:text-lg">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-3 border  rounded-md focus:outline-none focus:ring-2  text-white text-base"
                value={youtubeUrl}
