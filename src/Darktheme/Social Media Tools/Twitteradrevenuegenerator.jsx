        ...
        <div className="max-w-4xl mx-auto mt-7 p-2">
              ...
              <div className="flex flex-col sm:flex-row items-center mb-6 gap-2">
                <div className="w-full">
                  ...
                  <div className="relative z-10">
                    <button
                      type="button"
                      className="w-full p-2.5 border border-gray-300 rounded-md  flex items-center justify-between focus:outline-none"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    {dropdownOpen && (
                      <div className="absolute mt-1 w-full  bg-[#16283E]  text-white border rounded-md shadow-lg max-h-72 overflow-y-auto">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              className="bg-[#273D58] text-white  font-medium py-2.5 px-6 rounded-full flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
