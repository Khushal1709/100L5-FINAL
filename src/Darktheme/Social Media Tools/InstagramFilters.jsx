...
export default function InstagramFilters({ id = "Instagram Filters" }) {
    ...
    return (
        ...
        <div className="bg-[#16283E]">
            <div className="max-w-4xl mx-auto p-3 md:p-7 bg-[#16283E]">
                {/* Header */}
                <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
                    ...
                    <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 lg:justify-end lg:gap-2">
                        <button
                            ...
                            className="flex items-center justify-center md:w-auto px-3 py-2 text-sm rounded-xl border mb-2 md:mb-0 bg-[#273D58] border-white  text-white cursor-pointer"
                        >
                        ...
                        <button
                            ...
                            className={`px-3 py-2 rounded-xl border text-sm mt-2 md:mt-0 ml-0 cursor-pointer border-white text-white ${isFavorite
                                ? "bg-[#273D58]"
                                : "bg-[#273D58]"
                                }`}
                        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4 ">
                    <label className="w-full">
                        ...
                        />
                        <span className="w-full block cursor-pointer py-2 rounded-md text-center border border-gray-500 bg-[#273D58] text-gray-500">
                    ...
                    <div className="flex w-full">
                        <input
                            ...
                            className="flex-1 rounded-l-md border border-gray-500 px-3 py-2 focus:outline-none bg-[#273D58]   text-white"
                        />
                        <button
                            onClick={handleUrlUpload}
                            className="px-4 py-2 rounded-r-md  transition  bg-[#273D58] text-white border border-gray-500 "
                        >
                            Upload from URL
                        </button>
                    </div>
                ...
                <div
                    ...
                    className="w-full border-2 border-dashed border-white text-gray-400 rounded-lg px-4 py-6 text-center mb-4 bg-[#273D58] "
                ...
                >
                    <div className="">
                        ...
                        Drag your image here, or click to <span className=" text-gray-400  font-medium cursor-pointer ">browse</span>
                    </div>
                </div>

                {/* Main preview area */}
                <div className="w-full bg-[#273D58]  rounded-lg mb-4 flex items-center justify-center min-h-[160px] border border-gray-500 ">
                    {imgSrc ? (
                    ...
                    <div className="hidden md:flex gap-2 ">
                        {FILTERS.map((filter) => (
                            <button
                                key={filter.name}
                                onClick={() => setActive(filter.name)}
                                className={`cursor-pointer flex flex-col items-center f ${active === filter.name ? "border-2 border-white rounded" : ""
                                    }`}
                            >
                                <img
                                    src={imgSrc || PREVIEW_IMG}
                ...
                <div className="flex flex-col sm:flex-row w-full gap-2 justify-between items-center">
                    <button
                        ...
                        className="w-full sm:w-auto cursor-pointer px-6 py-2 rounded-full bg-[#273D58]  text-white border"
                    >
                        Reset
                    </button>
                    <button
                        ...
                        disabled={!imgSrc}
                        className={`w-full sm:w-auto cursor-pointer bg-[#273D58] border
                            px-6 py-2 rounded-full  flex items-center gap-2 ${imgSrc
                            ? "text-white"
                            : " text-white"
                            }`}
                    >
