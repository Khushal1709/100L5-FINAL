        ...
        <div className="max-w-4xl mx-auto  p-2">
          <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
            ...
            <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 lg:justify-end lg:gap-2 mt-5">
              ...
              <button
                className="flex items-center justify-center gap-2 w-full md:w-auto px-3 py-2 text-sm rounded-xl border cursor-pointer transition bg-[#273D58] text-white"
          ...
          <div className="text-white rounded-md shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 ">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-2 border  outline-none ${errors.title ? "border-red-500" : "border-gray-200"
                      } rounded-md`}
                  />
                  {errors.title && (
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.type}
                    onChange={handleChange}
                    className={`w-full p-2 border outline-none  bg-[#16283E]  text-white ${errors.type ? "border-red-500" : "border-gray-200"
                      } rounded-md`}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.url}
                    onChange={handleChange}
                    className={`w-full p-2 border outline-none ${errors.url ? "border-red-500" : "border-gray-300"
                      } rounded-md`}
                  />
                  {errors.url && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border outline-none ${errors.image ? "border-red-500" : "border-gray-200"
                      } rounded-md`}
                  />
                  {errors.image && (
            ...
            <div className="flex justify-center space-x-4 mt-8">
              <button
                onClick={handleReset}
                className="px-6 py-2 transition bg-[#273D58] text-white border  cursor-pointer rounded-lg  flex items-center"
              >
                Reset
              </button>
              <button
                onClick={handleGenerate}
                className="px-6 py-2 bg-[#273D58] text-white border cursor-pointer rounded-lg flex items-center"
              >
                Generate
              </button>
            </div>
