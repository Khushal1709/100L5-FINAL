           ...
           {/* Share Popup */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 rounded overflow-hidden">
                {shades.map((shade, i) => (
                    <div key={i} className="text-center">
                        ...
                        >
                            <button
                                className="absolute bottom-2 opacity-0 group-hover:opacity-100 transition-opacity bg-[#273D58] text-white border border-white  text-xs py-1 px-2 rounded"
                                onClick={(e) => {
                        ...
                        <div className="text-sm text-gray-500 py-1">{shade}</div>
                    </div>
                ))}
            </div>
            ...
            <div className="text-center mt-6">
                <button
                    ...
                    className="bg-[#273D58] text-white border border-white cursor-pointer px-6 py-2 rounded-lg"
                >
            ...
            {selectedShade && (
                <div className="mt-6 mx-auto w-fit bg-[#273D58] p-6 rounded-lg shadow text-center">
                    <div
