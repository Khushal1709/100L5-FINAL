...
export default function CubicBezierGenerator({ id = "CSS Cubic Bezier Generator" }) {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(
      `animation-timing-function: ${preset === "linear" ? "linear" : `cubic-bezier(${points.join(",")})`
  ...
  const cssOut = `animation-timing-function: ${preset === "linear" ? "linear" : `cubic-bezier(${points.join(",")})`
    };\nanimation-duration: ${duration}s;`;
  ...
  return (
   ...
   {open && (
        ...
        {/* Main Card */}
        <div className="bg-[#16283E] rounded-xl shadow-md p-6 flex flex-col gap-6 max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-6">
            {/* SVG Graph */}
            <div className="bg-[#16283E] text-white rounded-lg border px-4 py-3 flex flex-col items-center w-full max-w-md mx-auto">
            ...
            <div className="flex-1 flex flex-col gap-4">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <select
                    className="w-full border border-gray-200 outline-none rounded px-2 py-1 bg-[#16283E] text-white"
                    value={preset}
                ...
                {[0, 2].map((i, idx) => (
                  <div key={idx}>
                    <div className="flex items-center gap-1 mb-1">
                      <span
                        className={`h-2 w-2 rounded-full ${i === 0 ? "bg-green-500" : "bg-red-500"
                          }`}
                      />
                      <span
                        className={`text-xs font-semibold ${i === 0 ? "text-green-700" : "text-red-700"
                          }`}
                      >
                    ...
                    <input
                      ...
                      className="w-full accent-white"
                    />
                    <label className="block text-xs text-white mt-2 mb-0.5">
                      Y{i / 2 + 1}:{" "}
                      <span className="text-white">
