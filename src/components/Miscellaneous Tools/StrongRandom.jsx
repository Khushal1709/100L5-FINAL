      ...
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        <div>
          ...
          <select
            ...
            className="border border-blue-300 outline-none rounded px-2 py-1"
          >
  ...
  <label className="flex items-center gap-3 ">
    ...
    <span>
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-4">
        <button
          className="bg-gradient-to-r from-[#B8D0FF] to-[#E8D0FF] text-[#14143B] cursor-pointer px-4 py-2 rounded"
          onClick={handleGenerate}
        >
          Generate Password
        </button>
        <input
          className="flex-1 border border-blue-300 outline-none rounded px-3 py-2 font-mono text-lg"
          value={password}
          readOnly
        />
        <button
          className="bg-gradient-to-r from-[#B8D0FF] to-[#E8D0FF] text-[#14143B] px-3 py-2 rounded hover:bg-blue-200"
          onClick={handleCopy}
        >
          {copied ? "Copied!" : "Copy"}
        </button>
