  ...
  return (
    <>
      <div className="max-w-4xl mx-auto mt-8">
        <div className="w-full mx-auto max-w-4xl flex justify-center mb-6">
          {/* Header */}
          <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
            ...
            <div className="flex flex-col w-full md:flex-row md:justify-center md:items-center md:gap-4 lg:justify-end lg:gap-6">
              ...
              <button
                ...
                className={`px-3 py-2 rounded-xl border text-sm mt-2 md:mt-0 ${
                  isFavorite
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button
            className={`px-6 py-2 bg-white border border-gray-200 rounded-lg flex items-center gap-2 transition cursor-pointer ${
              isCopied
                ? "bg-gradient-to-r from-[#B8D0FF] to-[#E8D0FF] text-[#14143B]"
                : "bg-gradient-to-r from-[#B8D0FF] to-[#E8D0FF] text-[#14143B]"
            }`}
