...
export default function SvgToPngTool() {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen py-6 px-4 md:px-6 lg:px-8">
      {/* Header */}
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 mt-3">
        {/* Title */}
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">SVG&nbsp;to&nbsp;PNG&nbsp;Converter</h1>
        </div>
