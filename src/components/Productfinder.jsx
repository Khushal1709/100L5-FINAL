    ...
    return (
        <section className="w-full relative">
            ...
            <img
                src={Getleaf}
                alt="Leaf Background"
                className="hidden md:block absolute left-0 top-0 w-48 md:w-64 lg:w-80 opacity-5 z-0"
            />
                   ...
                   />
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex justify-between items-center bg-[#e3effc] rounded-full px-6 py-3">
                            <span class="text-[#23233c] font-medium">Product→Productivity→Cleansnap</span>
                            <a href="#" class="text-[#23233c] font-medium hover:underline">Boost</a>
                        </div>
                        {/* <!-- Card --> */}
                        <div class="bg-white rounded-3xl shadow p-6 md:p-10">
                            ...
                            <div class="text-[#888888] text-base leading-relaxed space-y-4 mb-6">
                                <p>
                                    Discover a growing, hand-curated collection of 2100+ highly useful tools and resources all in one place.
                                    Webcurate is a hand-curated directory that showcases daily a hand-curated selection of highly useful tools and resources for various use cases, including business, marketing, website development, content creation, productivity, design, and job-related needs.
                                </p>
                                <p>
                                    The platform currently features over 2100 tools and products in over 200 categories and serves as a comprehensive resource for users seeking high-quality, useful products and tools.
                                </p>
                                <p>
                                    It has features like dark theme support, multi-language support, a bookmarking option, and a clean, well-designed user interface. The platform is designed to make it easier for users to discover new and helpful online tools by offering detailed descriptions and features for each item listed.
                                </p>
                                <p>
                                    The platform was created and is updated by Hossein Yazdi, who has a passion for exploring and sharing online tools that can make tasks easier and more efficient.
                                </p>
                            </div>
                            {/* <!-- Visit Button --> */}
                            <div class="flex justify-end">
                                <a href="#" class="bg-[#0a1330] text-white rounded-full px-8 py-2 text-lg font-medium flex items-center gap-2 hover:bg-[#23233c] transition">
                                    Visit
                    ...
                    <div className="bg-[#f6f7fb] rounded-3xl p-8 max-w-7xl mx-auto mt-5 mb-5">
                        <h2 className="text-xl font-extrabold text-[#23233c] mb-6">Product Bento</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            {/* Categories */}
                            <div className="bg-white rounded-xl p-5">
                                <div className="font-bold text-[#23233c] mb-1">Categories</div>
                            ...
                            <div className="bg-white rounded-xl p-5">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <span className="bg-[#f6f7fb] text-[#888] text-xs px-3 py-1 rounded-full"># Event</span>
                                    <span className="bg-[#f6f7fb] text-[#888] text-xs px-3 py-1 rounded-full"># Event</span>
                                    <span className="bg-[#f6f7fb] text-[#888] text-xs px-3 py-1 rounded-full"># Event</span>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-5 flex flex-col justify-center">
                                <div className="font-bold text-[#23233c] mb-2">Social Media & Links</div>
                                <div className="flex gap-3">
                                    <a href="#" aria-label="Facebook" className="text-[#23233c] bg-[#f6f7fb] rounded-full w-8 h-8 flex items-center justify-center hover:bg-[#e0e1e5]">
                                    ...
                                    <a href="#" aria-label="Twitter" className="text-[#23233c] bg-[#f6f7fb] rounded-full w-8 h-8 flex items-center justify-center hover:bg-[#e0e1e5]">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="#" aria-label="LinkedIn" className="text-[#23233c] bg-[#f6f7fb] rounded-full w-8 h-8 flex items-center justify-center hover:bg-[#e0e1e5]">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="bg-white rounded-xl p-5 flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-[#23233c] font-medium">Hossein Yazdi</div>
