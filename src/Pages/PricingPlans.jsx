...
const plans = [
  {
    ...
    items: [
      ...
      "Preparation of TM Application Documents",
      "Drafting of TM Application",
    ],
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "Draft TM application Documents",
      "Draft TM Application",
      "Filling of TM Application��",
      "Replay of Trademark Objection",
      "Handling of TM Objection Hearing",
    ],
    highlight: false,
  },
];
