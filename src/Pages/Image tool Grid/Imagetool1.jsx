  ...
  const tools = [
    {
      title: "Image Resizer",
      description:
        "Resize any image to desired width and height either by protecting aspect ratio or not",
      icon: (
        <GiResize className="text-white w-[60px] p-1  h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/Resizer",
    },
    {
      ...
      icon: (
        <FaCropSimple className="text-white w-[60px] p-1  h-[60px] rounded-lg bg-yellow-400" />
      ),
      filename: "/ImageCropper",
    },
    {
      ...
      icon: (
        <MdFormatColorFill className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-pink-400" />
      ),
      filename: "/AverageColor",
    },
    {
      ...
      icon: (
        <PiImageSquareFill className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-orange-400" />
      ),
      filename: "/ImageColorExtractor",
    },
    {
      title: "Image Color Picker",
      description:
        "Use the eyedropper tool to pick any color from an image and view detailed information.",
      icon: (
        <TbColorPicker className="text-white w-[60px] p-1  h-[60px] rounded-lg bg-pink-400" />
      ),
      filename: "/ImageColorPicker",
    },
    {
      ...
      icon: (
        <TbFileTypeSvg className="text-white w-[60px] p-1  h-[60px] rounded-lg bg-orange-400" />
      ),
      filename: "/SVGpattern",
    },
    {
      title: "Photo Censor",
      description:
        "Censor photos and hide faces by pixelating/blurring them or by putting a black bar",
      icon: (
        <MdMovieFilter className="text-white w-[60px] p-1  h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/Photocensor",
    },
    {
      title: "SVG to PNG Converter",
      description:
        "Easily convert any SVG file to a PNG image and scale it with perfect proportions.",
      icon: (
        <SiConvertio className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-yellow-400" />
      ),
      filename: "/Svgpng",
    },
    {
      title: "Image Filter",
      description:
        "Apply various filters to images like brightness, contrast, blur and more effects",
      icon: (
        <TbFilters className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-blue-400" />
      ),
      filename: "/Imagefilter",
    },
    {
      title: "Image Caption",
      description:
        "Generate descriptive captions for images by applying advanced image analysis",
      icon: (
        <MdOutlineImageSearch className="text-white w-[60px] p-1 h-[60px] rounded-lg bg-yellow-400" />
      ),
      filename: "/ImageCaptionGenerator",
    },
    {
      title: "Blob Generator",
      description:
        "Create unique and customizable blob shapes to use backgrounds or design elements easily",
      icon: (
        <GiSlowBlob className="text-white w-[60px] h-[60px] p-1 rounded-lg bg-pink-400" />
      ),
